...
| **Setup** | Strompreis, **Controller automatisch finden**, Kopplung per Formular, Live-Status, **Geräte lokal umbenennen**, **Wärmepumpe (HomeCom) verbinden**, **Wärmepumpen-Historie als CSV importieren**, **AEG/Electrolux verbinden**, **Gesamt-Stromzähler** ablesen (kalibriert Prognosen & deckt fehlenden Hausstrom auf), **Verbrauchsdaten als CSV exportieren** (Tageswerte für Excel/Steuer), **Bridge aktualisieren** (Self-Update, manuell oder **automatisch** im Hintergrund) |
